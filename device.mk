...
PRODUCT_COPY_FILES += \
	device/nexell/allo_display/init.allo_display.rc:root/init.allo_display.rc \
	device/nexell/allo_display/init.allo_display.usb.rc:root/init.allo_display.usb.rc \
	device/nexell/allo_display/fstab.allo_display:root/fstab.allo_display \
	device/nexell/allo_display/ueventd.allo_display.rc:root/ueventd.allo_display.rc \
	device/nexell/allo_display/init.recovery.allo_display.rc:root/init.recovery.allo_display.rc
...
PRODUCT_COPY_FILES += \
	device/nexell/allo_display/mixer_paths.xml:system/etc/mixer_paths.xml \
	device/nexell/allo_display/audio_policy_configuration.xml:system/etc/audio_policy_configuration.xml \
	device/nexell/allo_display/audio_policy_volumes.xml:system/etc/audio_policy_volumes.xml \
	device/nexell/allo_display/a2dp_audio_policy_configuration.xml:system/etc/a2dp_audio_policy_configuration.xml \
	device/nexell/allo_display/usb_audio_policy_configuration.xml:system/etc/usb_audio_policy_configuration.xml \
	device/nexell/allo_display/r_submix_audio_policy_configuration.xml:system/etc/r_submix_audio_policy_configuration.xml \
	device/nexell/allo_display/default_volume_tables.xml:system/etc/default_volume_tables.xml

PRODUCT_COPY_FILES += \
	device/nexell/allo_display/audio/tiny_hw.allo_display.xml:system/etc/tiny_hw.allo_display.xml \
	device/nexell/allo_display/audio/audio_policy.conf:system/etc/audio_policy.conf

PRODUCT_COPY_FILES += \
	frameworks/av/media/libstagefright/data/media_codecs_google_audio.xml:system/etc/media_codecs_google_audio.xml \
	device/nexell/allo_display/media_codecs.xml:system/etc/media_codecs.xml \
	device/nexell/allo_display/media_profiles.xml:system/etc/media_profiles.xml \

# bluetooth
PRODUCT_COPY_FILES += \
        frameworks/native/data/etc/android.hardware.bluetooth_le.xml:system/etc/permissions/android.hardware.bluetooth_le.xml \
        frameworks/native/data/etc/android.hardware.bluetooth.xml:system/etc/permissions/android.hardware.bluetooth.xml \
        device/nexell/allo_display/bluetooth/bt_vendor.conf:system/etc/bluetooth/bt_vendor.conf \
        device/nexell/allo_display/bluetooth/BCM434545.hcd:system/vendor/firmware/BCM434545.hcd \
        device/nexell/allo_display/bluetooth/BCM20710A1_001.002.014.0103.0117.hcd:system/vendor/firmware/BCM20710A1_001.002.014.0103.0117.hcd
...
# input
PRODUCT_COPY_FILES += \
	device/nexell/allo_display/gpio_keys.kl:system/usr/keylayout/gpio_keys.kl \
	device/nexell/allo_display/gpio_keys.kcm:system/usr/keychars/gpio_keys.kcm

# hardware features
PRODUCT_COPY_FILES += \
	device/nexell/allo_display/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml \
...
# wallpaper
PRODUCT_COPY_FILES += \
	device/nexell/allo_display/wallpaper:/data/system/users/0/wallpaper \
	device/nexell/allo_display/wallpaper_orig:/data/system/users/0/wallpaper_orig \
	device/nexell/allo_display/wallpaper_info.xml:/data/system/users/0/wallpaper_info.xml
...
# HAL
PRODUCT_PACKAGES += \
	gralloc.allo_display \
	libGLES_mali \
	hwcomposer.allo_display \
	audio.primary.allo_display \
	memtrack.allo_display 
...
DEVICE_PACKAGE_OVERLAYS := device/nexell/allo_display/overlay
...
#bootanimation
PRODUCT_COPY_FILES += \
	device/nexell/allo_display/bootanimation.zip:system/media/bootanimation.zip
#WIFI
PRODUCT_COPY_FILES += \
	device/nexell/allo_display/wifi/dhd:system/bin/dhd \
	device/nexell/allo_display/wifi/wl:system/bin/wl \
	device/nexell/allo_display/wifi/bcmdhd.cal:system/etc/wifi/bcmdhd.cal \
	device/nexell/allo_display/wifi/fw_bcmdhd.bin:system/etc/firmware/fw_bcmdhd.bin \
	device/nexell/allo_display/wifi/fw_bcmdhd_apsta.bin:system/etc/firmware/fw_bcmdhd_apsta.bin
