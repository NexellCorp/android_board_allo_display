...
function usage()
{
    echo "Usage: $0 -s <chip-name> [-t <build-target>] [-d <result-dir>] [-T <android-build-tag>] [-V <build-version>] [-i <previous-target.zip>] [-q]"
