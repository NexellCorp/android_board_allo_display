...
PRODUCT_NAME := aosp_allo_display
PRODUCT_DEVICE := allo_display
PRODUCT_BRAND := Android
PRODUCT_MODEL := AOSP on allo_display
...
PRODUCT_COPY_FILES += \
	device/nexell/kernel/kernel-4.4.x/arch/arm/boot/dts/s5p4418-allo_display-rev01.dtb:2ndbootloader

PRODUCT_PROPERTY_OVERRIDES += \
	ro.product.first_api_level=21

# Disable bluetooth because allo_display does not use bluetooth source
...
$(call inherit-product, device/nexell/allo_display/device.mk)
